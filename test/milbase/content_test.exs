defmodule Milbase.ContentTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{active: true, content: "some content"}
    @update_attrs %{active: false, content: "some updated content"}
    @invalid_attrs %{active: nil, content: nil}
